  ...
  'click .add' : function (options) {
    ...
    'change .liststate' : function (event) {
      var places = {
            ...
            'Pennsylvania': ['Philladelphia', 'Pittsburgh', 'Allentown', 'Erie', 'Reading', 'Scranton', 'Bethlehem', 'Lancaster', 'Levittown', 'Harrisburg'], 
...
Template.headerpost.helpers({
  global : function () {
   return ['Activities', 'Meetup Request Manager', 'Listing Manager', 'Meetup History', 'Account Settings']
 },
  ...
  general : function () { 
    ['Report','Help Center', 'Advertising','Logout'] }
