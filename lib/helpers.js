		...
		addListingMapOptions: function () {
			if ( GoogleMaps.loaded() ) {
				...
				if ( Geolocation.error() ) {
					...
					swal({   
					   title: "Are you sure you want to disable geolocation?",
					   text: "You will not be able to automatically focus to your neighborhood without this enabled!",
					   type: "warning",
					   showCancelButton: true,
					   cancelButtonText: "Leave it disabled",
					   confirmButtonColor: "#DD6B55",   
					   confirmButtonText: "Ok, Enable it",
					   closeOnConfirm: true },
					   function () {
