if (Meteor.isClient){
	...
	Template.addlisting.helpers({
		...
		// Provide Alternative for specifying location without Google location auto locate
 ...
 //  		}
    ...
    Template.UserProfile.helpers({
    	facebook: function () {
    		//Get the link of the facebook user
    	},
    	name: function () {
	...
	Template.item.helpers({
		...
		messenger: function () {
			...
			console.log(Meteor.users.find({_id: creator_id}).fetch()[0]);
