    ...
    Template.addlisting.events({
      'click .add' : function (options) {
        ...
        function addListingValidate() {
          ...
          // TASK - FIX - Page view is pushed down on run
        ...
        function successMessage() {
           Router.go("/");
           sweetAlert({   
                    title: "Sucessfully Created Listing",
                    text: "Listing: " + "<span style='color: #f8504b'>" + options.listing_title + "</span>" + " Created",
                    timer: 3000,
                    type: "success",
