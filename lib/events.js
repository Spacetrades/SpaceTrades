...
Template.UserProfileSettings.events({
  'click .profileSettingsSubmit': function () {
    ...
    // TASK -Slingshot upload to the server, get url and pass as profile
    var options = {
      photo: "nn",
      about: "Default is no cool",
      email: "nchackerian@gmail",
      location: "Brooklyn, new york",
      link: "spacetrades.com/asd"
    }
...
Template.item.events({
  'click ListingContact': function () {
    // Create a stub in messages with the url of the person you are messaging. Add to the top of stubs
